        ...
        <Card className={cn(className)}>
            <CardHeader className="flex flex-row items-center justify-between">
                <div>
                    ...
                    >
                        Infrastructure associated with this deployment. To add
                        configuration templates, select the infrastructure
                        below.
                    </CardDescription>
                </div>
                <div
                        ...
                        {showVariables ? (
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Complete the form below to add template
                                        variables. Required fields are marked
                                        with an asterisk.
                                    </DialogDescription>
                                </DialogHeader>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        ...
                                        infrastructure to this deployment.
